...
<br><br>
<b>What now?</b><br>
&mdash; Please remove the <i>install.php</i> file from your NAFLM folder and <a href='index.php'>continue to the main page</a>.<br> 
...
EOL;
		...
		<form method="POST">
			<input type="submit" name="setup" value="Setup DB for NAFLM">
		</form>
		<?php
	}
}
