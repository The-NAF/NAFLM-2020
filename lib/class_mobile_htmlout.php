            ...
            <div id="PlayerDialog" data-bind="with: playerDialogViewModel">
                <table>
                    <tbody>
                        ...
                        <tr><td>MA/ST/AG/PA/AV:</td><td class="data" data-bind="text: statString"></td></tr>
                        ...
                        <tr data-bind="visible: mayBuyNewSkill">
                            ...
                            <td>
                                <select data-bind="value: selectedNewSkill">
                                    ...
                                    <optgroup label="Characteristic improvement" data-bind="foreach: choosableCharacteristicIncreases">
                                        <option data-bind="value: id, text: name" />
                                    </optgroup>
                                </select>
