			...
			<div class="boxPlayerPageInfo">
				...
				<div class="boxBody">
					<table class="pbox">
						...
						<tr>
							<td><b>CurrentSPP/Spent/Total</b></td>
							<?php $tspp = $p->mv_spp - $p->extra_spp ?>
							<td><?php echo "$p->mv_spp/$p->extra_spp/$tspp" ?></td>
						</tr>
						<?php
			...
			<div class="boxWide">
				...
				<div class="boxBody" id="ach" style='display:none;'>
					<table class="common">
						...
						<?php
						foreach (array('deflct' => 'Deflections', 'intcpt' => 'Interceptions', 'cp' => 'Completions', 'td' => 'Touchdowns', 'mvp' => 'MVP awards', 'bh+ki+si' => 'Cas') as $s => $desc) {
							$been_there = false;
				...
				<div class="boxBody" id="injhist">
					<table class="common">
						...
						foreach (array_keys($injhist) as $mid) {
							...
							<td><?php echo $stats[$mid]['deflct']; ?></td>
