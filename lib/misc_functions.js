...
function addStarMerc(table_id, id)
{
    ...
    */
    ...
    var fields = ['Name', 'Hiring cost', 'Additional skills', 'MVP', 'Cp', 'TD', 'Def', 'Int', 'BH', 'SI', 'Ki', 'Misc SPP', 'Remove'];
    ...
    if (id == ID_MERCS) {
        ...
        x[6] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" value="0" id="deflct'+idm+'" name="deflct'+idm+'">';
        x[7] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" value="0" id="intcpt'+idm+'" name="intcpt'+idm+'">';
        x[8] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" value="0" id="bh'+idm+'" name="bh'+idm+'">';
        x[9] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" value="0" id="si'+idm+'" name="si'+idm+'">';
        x[10] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" value="0" id="ki'+idm+'" name="ki'+idm+'">';
        x[11] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" value="0" id="misc'+idm+'" name="misc'+idm+'">';
        x[12] = '<a href="javascript:void(0)" onclick="rmStarMerc('+ID_MERCS+','+MERC_CNT+');">Remove</a>';
        MERC_CNT++;
    }
    // Star?
    else {
        ...
        x[6] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" id="deflct_'+id+'" name="deflct_'+id+'" value="0">';
        x[7] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" id="intcpt_'+id+'" name="intcpt_'+id+'" value="0">';
        x[8] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" id="bh_'+id+'" name="bh_'+id+'" value="0">';
        x[9] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" id="si_'+id+'" name="si_'+id+'" value="0">';
        x[10] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" id="ki_'+id+'" name="ki_'+id+'" value="0">';
        x[11] = '<input type="text" onChange="numError(this);" size="1" maxlength="2" id="misc_'+id+'" name="misc_'+id+'" value="0">';
        x[12] = '<a href="javascript:void(0)" onclick="rmStarMerc('+id+',0);">Remove</a>';
