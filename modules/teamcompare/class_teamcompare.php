...
protected static function _compare($tid1, $tid2) 
{
    ...
    <table style='width:70%; '>
        ...
        <tr><td>Def</td>
            <td><?php self::_bar($t1->mv_deflct/self::$T_MAX_INT *100, $t1->mv_deflct, $t1->mv_deflct/self::$T_MAX_INT *100);?></td>
            <td><?php self::_bar($t2->mv_deflct/self::$T_MAX_INT *100, $t2->mv_deflct, $t2->mv_deflct/self::$T_MAX_INT *100);?></td>
        </tr>
        <tr><td>Int</td>
